...
async function processNextChunk(tabId, state) {
  ...
  try {
    ...
    // No return_timestamps — it forces slow sequential timestamp-token
    // decoding and roughly doubles inference time. We don't need per-word
    // timing for live captions.
